...
namespace rocos
{
    ...
    public:
        ...
        explicit Robot(HardwareInterface *hw,
                       ...
                       const string &tip = "link7",
                       bool externally_scheduled = false);
    ...
    protected:
        // 双臂控制器拥有唯一的周期线程，使用 URDF 链而非工作目录中的 DH 文件。
        bool externally_scheduled_{false};
        // void addAllJoints();
    ...
    protected:
        ...
        std::atomic<bool> is_running_motion_{false};           // 运动线程退出标志
