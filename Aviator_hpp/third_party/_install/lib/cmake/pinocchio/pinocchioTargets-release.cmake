...
list(APPEND _IMPORT_CHECK_FILES_FOR_pinocchio::pinocchio_default "${_IMPORT_PREFIX}/lib/libpinocchio_default.so.3.9.0" )
...
set_target_properties(pinocchio::pinocchio_collision PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpinocchio_collision.so.3.9.0"
  IMPORTED_SONAME_RELEASE "libpinocchio_collision.so.3.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS pinocchio::pinocchio_collision )
list(APPEND _IMPORT_CHECK_FILES_FOR_pinocchio::pinocchio_collision "${_IMPORT_PREFIX}/lib/libpinocchio_collision.so.3.9.0" )
...
list(APPEND _IMPORT_CHECK_TARGETS pinocchio::pinocchio_visualizers )
list(APPEND _IMPORT_CHECK_FILES_FOR_pinocchio::pinocchio_visualizers "${_IMPORT_PREFIX}/lib/libpinocchio_visualizers.so.3.9.0" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_pinocchio::pinocchio_parsers "${_IMPORT_PREFIX}/lib/libpinocchio_parsers.so.3.9.0" )
