...
#ifndef HPP_UTIL_WARNING_HH
# define HPP_UTIL_WARNING_HH

// Emits a warning in a portable way.
//
// To emit a warning, one can insert:
//
// #pragma message HPP_UTIL_WARN("your warning message here")
//
...
# define HPP_UTIL_WARN_STRINGISE_IMPL(x) #x
# define HPP_UTIL_WARN_STRINGISE(x) \
         HPP_UTIL_WARN_STRINGISE_IMPL(x)
# ifdef __GNUC__
#   define HPP_UTIL_WARN(exp) ("WARNING: " exp)
# else
#  ifdef _MSC_VER
#   define FILE_LINE_LINK __FILE__ "(" \
           HPP_UTIL_WARN_STRINGISE(__LINE__) ") : "
#   define HPP_UTIL_WARN(exp) (FILE_LINE_LINK "WARNING: " exp)
#  else
// If the compiler is not recognized, drop the feature.
#   define HPP_UTIL_WARN(MSG) /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! HPP_UTIL_WARNING_HH
